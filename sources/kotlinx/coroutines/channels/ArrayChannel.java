...
public class ArrayChannel<E> extends AbstractChannel<E> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:29:0x006a, code lost:
        if ((r7 instanceof kotlinx.coroutines.channels.Closed) == false) goto L_0x0072;
     */
    ...
    public java.lang.Object pollSelectInternal(kotlinx.coroutines.selects.SelectInstance<?> r9) {
        /*
            ...
            r2.lock()
            int r3 = r8.size     // Catch:{ all -> 0x00d3 }
            if (r3 != 0) goto L_0x001c
            kotlinx.coroutines.channels.Closed r8 = r8.getClosedForSend()     // Catch:{ all -> 0x00d3 }
            if (r8 == 0) goto L_0x0016
            goto L_0x0018
        L_0x0016:
            kotlinx.coroutines.internal.Symbol r8 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00d3 }
        L_0x0018:
            r2.unlock()
            return r8
        L_0x001c:
            java.lang.Object[] r4 = r8.buffer     // Catch:{ all -> 0x00d3 }
            int r5 = r8.head     // Catch:{ all -> 0x00d3 }
            r6 = r4[r5]     // Catch:{ all -> 0x00d3 }
            r4[r5] = r0     // Catch:{ all -> 0x00d3 }
            int r0 = r3 + -1
            r8.size = r0     // Catch:{ all -> 0x00d3 }
            kotlinx.coroutines.internal.Symbol r0 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00d3 }
            int r4 = r8.capacity     // Catch:{ all -> 0x00d3 }
            r5 = 1
            if (r3 != r4) goto L_0x0091
        L_0x002f:
            kotlinx.coroutines.channels.AbstractChannel$TryPollDesc r4 = r8.describeTryPoll()     // Catch:{ all -> 0x00d3 }
            r7 = r4
            kotlinx.coroutines.internal.AtomicDesc r7 = (kotlinx.coroutines.internal.AtomicDesc) r7     // Catch:{ all -> 0x00d3 }
            java.lang.Object r7 = r9.performAtomicTrySelect(r7)     // Catch:{ all -> 0x00d3 }
            if (r7 != 0) goto L_0x004c
            java.lang.Object r0 = r4.getResult()     // Catch:{ all -> 0x00d3 }
            r1 = r0
            kotlinx.coroutines.channels.Send r1 = (kotlinx.coroutines.channels.Send) r1     // Catch:{ all -> 0x00d3 }
            kotlin.jvm.internal.Intrinsics.checkNotNull(r1)     // Catch:{ all -> 0x00d3 }
            java.lang.Object r0 = r1.getPollResult()     // Catch:{ all -> 0x00d3 }
            r4 = r5
            goto L_0x0092
        L_0x004c:
            kotlinx.coroutines.internal.Symbol r4 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00d3 }
            if (r7 != r4) goto L_0x0051
            goto L_0x0091
        L_0x0051:
            java.lang.Object r4 = kotlinx.coroutines.internal.AtomicKt.RETRY_ATOMIC     // Catch:{ all -> 0x00d3 }
            if (r7 != r4) goto L_0x0056
            goto L_0x002f
        L_0x0056:
            java.lang.Object r0 = kotlinx.coroutines.selects.SelectKt.getALREADY_SELECTED()     // Catch:{ all -> 0x00d3 }
            if (r7 != r0) goto L_0x0068
            r8.size = r3     // Catch:{ all -> 0x00d3 }
            java.lang.Object[] r9 = r8.buffer     // Catch:{ all -> 0x00d3 }
            int r8 = r8.head     // Catch:{ all -> 0x00d3 }
            r9[r8] = r6     // Catch:{ all -> 0x00d3 }
            r2.unlock()
            return r7
        L_0x0068:
            boolean r0 = r7 instanceof kotlinx.coroutines.channels.Closed     // Catch:{ all -> 0x00d3 }
            ...
            goto L_0x0092
        L_0x0072:
            java.lang.StringBuilder r8 = new java.lang.StringBuilder     // Catch:{ all -> 0x00d3 }
            r8.<init>()     // Catch:{ all -> 0x00d3 }
            java.lang.String r9 = "performAtomicTrySelect(describeTryOffer) returned "
            java.lang.StringBuilder r8 = r8.append(r9)     // Catch:{ all -> 0x00d3 }
            java.lang.StringBuilder r8 = r8.append(r7)     // Catch:{ all -> 0x00d3 }
            java.lang.String r8 = r8.toString()     // Catch:{ all -> 0x00d3 }
            java.lang.IllegalStateException r9 = new java.lang.IllegalStateException     // Catch:{ all -> 0x00d3 }
            java.lang.String r8 = r8.toString()     // Catch:{ all -> 0x00d3 }
            r9.<init>(r8)     // Catch:{ all -> 0x00d3 }
            java.lang.Throwable r9 = (java.lang.Throwable) r9     // Catch:{ all -> 0x00d3 }
            throw r9     // Catch:{ all -> 0x00d3 }
        L_0x0091:
            r4 = 0
        L_0x0092:
            kotlinx.coroutines.internal.Symbol r7 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00d3 }
            if (r0 == r7) goto L_0x00a6
            boolean r7 = r0 instanceof kotlinx.coroutines.channels.Closed     // Catch:{ all -> 0x00d3 }
            if (r7 != 0) goto L_0x00a6
            r8.size = r3     // Catch:{ all -> 0x00d3 }
            java.lang.Object[] r9 = r8.buffer     // Catch:{ all -> 0x00d3 }
            int r7 = r8.head     // Catch:{ all -> 0x00d3 }
            int r7 = r7 + r3
            int r3 = r9.length     // Catch:{ all -> 0x00d3 }
            int r7 = r7 % r3
            r9[r7] = r0     // Catch:{ all -> 0x00d3 }
            goto L_0x00bc
        L_0x00a6:
            boolean r9 = r9.trySelect()     // Catch:{ all -> 0x00d3 }
            if (r9 != 0) goto L_0x00bc
            r8.size = r3     // Catch:{ all -> 0x00d3 }
            java.lang.Object[] r9 = r8.buffer     // Catch:{ all -> 0x00d3 }
            int r8 = r8.head     // Catch:{ all -> 0x00d3 }
            r9[r8] = r6     // Catch:{ all -> 0x00d3 }
            java.lang.Object r8 = kotlinx.coroutines.selects.SelectKt.getALREADY_SELECTED()     // Catch:{ all -> 0x00d3 }
            r2.unlock()
            return r8
        L_0x00bc:
            int r9 = r8.head     // Catch:{ all -> 0x00d3 }
            int r9 = r9 + r5
            java.lang.Object[] r0 = r8.buffer     // Catch:{ all -> 0x00d3 }
            int r0 = r0.length     // Catch:{ all -> 0x00d3 }
            int r9 = r9 % r0
            r8.head = r9     // Catch:{ all -> 0x00d3 }
            kotlin.Unit r8 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x00d3 }
            r2.unlock()
