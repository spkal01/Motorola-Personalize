...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    public boolean enqueueReceiveInternal(Receive<? super E> receive) {
        ...
        if (isBufferAlwaysEmpty()) {
            ...
            LockFreeLinkedListNode.CondAddOp abstractChannel$enqueueReceiveInternal$$inlined$addLastIfPrevAndIf$1 = new C1106x75f916ce(lockFreeLinkedListNode, lockFreeLinkedListNode, this);
            do {
    ...
    public final java.lang.Object m1499receiveOrClosedZYPwvRU(kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ValueOrClosed<? extends E>> r5) {
        /*
            r4 = this;
        ...
        L_0x0038:
            ...
            kotlinx.coroutines.channels.ValueOrClosed$Companion r4 = kotlinx.coroutines.channels.ValueOrClosed.Companion
            kotlinx.coroutines.channels.Closed r5 = (kotlinx.coroutines.channels.Closed) r5
            java.lang.Throwable r4 = r5.closeCause
            kotlinx.coroutines.channels.ValueOrClosed$Closed r5 = new kotlinx.coroutines.channels.ValueOrClosed$Closed
            r5.<init>(r4)
            java.lang.Object r4 = kotlinx.coroutines.channels.ValueOrClosed.m1504constructorimpl(r5)
            goto L_0x005d
        L_0x0057:
            kotlinx.coroutines.channels.ValueOrClosed$Companion r4 = kotlinx.coroutines.channels.ValueOrClosed.Companion
            java.lang.Object r4 = kotlinx.coroutines.channels.ValueOrClosed.m1504constructorimpl(r5)
        ...
        L_0x006c:
            ...
            java.lang.Object r4 = r5.m1513unboximpl()
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.AbstractChannel.m1499receiveOrClosedZYPwvRU(kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    public void onCancelIdempotent(boolean z) {
        ...
        if (closedForSend != null) {
            Object r4 = InlineList.m1526constructorimpl$default((Object) null, 1, (DefaultConstructorMarker) null);
            while (true) {
                LockFreeLinkedListNode prevNode = closedForSend.getPrevNode();
                if (prevNode instanceof LockFreeLinkedListHead) {
                    if (r4 != null) {
                        if (!(r4 instanceof ArrayList)) {
                            ((Send) r4).resumeSendClosed(closedForSend);
                            return;
                        }
                        Objects.requireNonNull(r4, "null cannot be cast to non-null type kotlin.collections.ArrayList<E> /* = java.util.ArrayList<E> */");
                    ...
                    r4 = InlineList.m1531plusUZ7vuAc(r4, (Send) prevNode);
                }
            }
        } else {
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) {
        ...
        if (z) {
            if (i == 0) {
                ...
                UndispatchedKt.startCoroutineUnintercepted(function2, ValueOrClosed.m1503boximpl(ValueOrClosed.m1504constructorimpl(new ValueOrClosed.Closed(((Closed) obj).closeCause))), selectInstance.getCompletion());
            }
        } else if (i == 2) {
            if (z) {
                ValueOrClosed.Companion companion2 = ValueOrClosed.Companion;
                obj2 = ValueOrClosed.m1504constructorimpl(new ValueOrClosed.Closed(((Closed) obj).closeCause));
            } else {
                ValueOrClosed.Companion companion3 = ValueOrClosed.Companion;
                obj2 = ValueOrClosed.m1504constructorimpl(obj);
            }
            UndispatchedKt.startCoroutineUnintercepted(function2, ValueOrClosed.m1503boximpl(obj2), selectInstance.getCompletion());
        } else {
            ...
            while (true) {
                ...
                if (pollInternal instanceof Closed) {
                    ...
                    if (closed.closeCause == null) {
                        ...
                        cancellableContinuation.resumeWith(Result.m108constructorimpl(boxBoolean));
                    } else {
                        Throwable receiveException = closed.getReceiveException();
                        Result.Companion companion2 = Result.Companion;
                        cancellableContinuation.resumeWith(Result.m108constructorimpl(ResultKt.createFailure(receiveException)));
                    }
    ...
    private static class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E e) {
            ...
            ValueOrClosed.Companion companion = ValueOrClosed.Companion;
            return ValueOrClosed.m1503boximpl(ValueOrClosed.m1504constructorimpl(e));
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode == 1 && closed.closeCause == null) {
                Result.Companion companion = Result.Companion;
                this.cont.resumeWith(Result.m108constructorimpl((Object) null));
            } else if (this.receiveMode == 2) {
                ValueOrClosed.Companion companion2 = ValueOrClosed.Companion;
                ValueOrClosed r3 = ValueOrClosed.m1503boximpl(ValueOrClosed.m1504constructorimpl(new ValueOrClosed.Closed(closed.closeCause)));
                Result.Companion companion3 = Result.Companion;
                this.cont.resumeWith(Result.m108constructorimpl(r3));
            } else {
                Throwable receiveException = closed.getReceiveException();
                Result.Companion companion4 = Result.Companion;
                this.cont.resumeWith(Result.m108constructorimpl(ResultKt.createFailure(receiveException)));
            }
        }
    ...
    private static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        public void completeResumeReceive(E e) {
            ...
            if (this.receiveMode == 2) {
                ValueOrClosed.Companion companion = ValueOrClosed.Companion;
                e2 = ValueOrClosed.m1503boximpl(ValueOrClosed.m1504constructorimpl(e));
            } else {
                e2 = e;
            }
            ...
            if (this.select.trySelect()) {
                ...
                if (i == 0) {
                    ...
                    if (i == 2) {
                        Function2<Object, Continuation<? super R>, Object> function2 = this.block;
                        ValueOrClosed.Companion companion = ValueOrClosed.Companion;
                        CancellableKt.startCoroutineCancellable$default(function2, ValueOrClosed.m1503boximpl(ValueOrClosed.m1504constructorimpl(new ValueOrClosed.Closed(closed.closeCause))), this.select.getCompletion(), (Function1) null, 4, (Object) null);
                    }
