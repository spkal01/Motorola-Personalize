...
@DebugMetadata(mo16174c = "kotlinx.coroutines.flow.FlowKt__LimitKt$transformWhile$1", mo16175f = "Limit.kt", mo16176i = {0, 0, 0}, mo16177l = {154}, mo16178m = "invokeSuspend", mo16179n = {"$this$flow", "$this$collectWhile$iv", "collector$iv"}, mo16180s = {"L$0", "L$1", "L$2"})
...
final class FlowKt__LimitKt$transformWhile$1 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        flowKt__LimitKt$transformWhile$1.f231p$ = (FlowCollector) obj;
    ...
    public final Object invokeSuspend(Object obj) {
        C1137xdf1aa1b6 flowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = this.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            FlowCollector flowCollector = this.f231p$;
            Flow flow = this.$this_transformWhile;
            C1137xdf1aa1b6 flowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$12 = new C1137xdf1aa1b6(this, flowCollector);
            try {
            ...
            flowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1 = (C1137xdf1aa1b6) this.L$2;
