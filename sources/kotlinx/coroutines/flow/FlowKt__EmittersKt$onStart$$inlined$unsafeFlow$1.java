...
public final class FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 implements Flow<T> {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:25:0x00aa A[RETURN] */
    ...
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector r8, kotlin.coroutines.Continuation r9) {
        /*
            r7 = this;
            boolean r0 = r9 instanceof kotlinx.coroutines.flow.FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1.C11251
            if (r0 == 0) goto L_0x0014
            r0 = r9
            kotlinx.coroutines.flow.FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1$1 r0 = (kotlinx.coroutines.flow.FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1.C11251) r0
            int r1 = r0.label
        ...
        L_0x0063:
            ...
            r5.<init>(r8, r9)
            kotlin.jvm.functions.Function2 r9 = r7.$action$inlined     // Catch:{ all -> 0x00ae }
            r0.L$0 = r7     // Catch:{ all -> 0x00ae }
            r0.L$1 = r8     // Catch:{ all -> 0x00ae }
            r0.L$2 = r2     // Catch:{ all -> 0x00ae }
            r0.L$3 = r8     // Catch:{ all -> 0x00ae }
            r0.L$4 = r5     // Catch:{ all -> 0x00ae }
            r0.label = r4     // Catch:{ all -> 0x00ae }
            r4 = 6
            kotlin.jvm.internal.InlineMarker.mark((int) r4)     // Catch:{ all -> 0x00ae }
            java.lang.Object r9 = r9.invoke(r5, r0)     // Catch:{ all -> 0x00ae }
            r4 = 7
            kotlin.jvm.internal.InlineMarker.mark((int) r4)     // Catch:{ all -> 0x00ae }
