...
final class SharedFlowImpl<T> extends AbstractSharedFlow<SharedFlowSlot> implements MutableSharedFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:37:0x00b2 A[Catch:{ all -> 0x00dd }] */
    /* JADX WARNING: Removed duplicated region for block: B:42:0x00ca A[Catch:{ all -> 0x00dd }] */
    ...
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r9, kotlin.coroutines.Continuation<? super kotlin.Unit> r10) {
        ...
        L_0x003e:
            kotlin.ResultKt.throwOnFailure(r10)     // Catch:{ all -> 0x0060 }
            r10 = r2
            r2 = r8
            r8 = r5
            goto L_0x00aa
        ...
        L_0x007a:
            ...
            boolean r2 = r9 instanceof kotlinx.coroutines.flow.SubscribedFlowCollector     // Catch:{ all -> 0x00e1 }
            if (r2 == 0) goto L_0x0099
            r2 = r9
            kotlinx.coroutines.flow.SubscribedFlowCollector r2 = (kotlinx.coroutines.flow.SubscribedFlowCollector) r2     // Catch:{ all -> 0x00e1 }
            r0.L$0 = r8     // Catch:{ all -> 0x00e1 }
            r0.L$1 = r9     // Catch:{ all -> 0x00e1 }
            r0.L$2 = r10     // Catch:{ all -> 0x00e1 }
            r0.label = r5     // Catch:{ all -> 0x00e1 }
            java.lang.Object r2 = r2.onSubscription(r0)     // Catch:{ all -> 0x00e1 }
        ...
        L_0x0099:
            ...
            r9 = r7
        L_0x009c:
            kotlin.coroutines.CoroutineContext r2 = r0.getContext()     // Catch:{ all -> 0x00dd }
            kotlinx.coroutines.Job$Key r5 = kotlinx.coroutines.Job.Key     // Catch:{ all -> 0x00dd }
            kotlin.coroutines.CoroutineContext$Key r5 = (kotlin.coroutines.CoroutineContext.Key) r5     // Catch:{ all -> 0x00dd }
            kotlin.coroutines.CoroutineContext$Element r2 = r2.get(r5)     // Catch:{ all -> 0x00dd }
            kotlinx.coroutines.Job r2 = (kotlinx.coroutines.Job) r2     // Catch:{ all -> 0x00dd }
        L_0x00aa:
            java.lang.Object r5 = r8.tryTakeValue(r9)     // Catch:{ all -> 0x00dd }
            kotlinx.coroutines.internal.Symbol r6 = kotlinx.coroutines.flow.SharedFlowKt.NO_VALUE     // Catch:{ all -> 0x00dd }
            if (r5 == r6) goto L_0x00ca
            if (r2 == 0) goto L_0x00b7
            kotlinx.coroutines.JobKt.ensureActive((kotlinx.coroutines.Job) r2)     // Catch:{ all -> 0x00dd }
        L_0x00b7:
            r0.L$0 = r8     // Catch:{ all -> 0x00dd }
            r0.L$1 = r10     // Catch:{ all -> 0x00dd }
            r0.L$2 = r9     // Catch:{ all -> 0x00dd }
            r0.L$3 = r2     // Catch:{ all -> 0x00dd }
            r0.L$4 = r5     // Catch:{ all -> 0x00dd }
            r0.label = r3     // Catch:{ all -> 0x00dd }
            java.lang.Object r5 = r10.emit(r5, r0)     // Catch:{ all -> 0x00dd }
        ...
        L_0x00ca:
            ...
            java.lang.Object r5 = r8.awaitValue(r9, r0)     // Catch:{ all -> 0x00dd }
            if (r5 != r1) goto L_0x00aa
            return r1
        L_0x00dd:
            r10 = move-exception
    ...
    @Metadata(mo15460bv = {1, 0, 3}, mo15461d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003\b\u0002\u0018\u00002\u00020\u0001B1\u0012\n\u0010\u0002\u001a\u0006\u0012\u0002\b\u00030\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\b\u0010\u0006\u001a\u0004\u0018\u00010\u0007\u0012\f\u0010\b\u001a\b\u0012\u0004\u0012\u00020\n0\t¢\u0006\u0002\u0010\u000bJ\b\u0010\f\u001a\u00020\nH\u0016R\u0016\u0010\b\u001a\b\u0012\u0004\u0012\u00020\n0\t8\u0006X\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0002\u001a\u0006\u0012\u0002\b\u00030\u00038\u0006X\u0004¢\u0006\u0002\n\u0000R\u0012\u0010\u0004\u001a\u00020\u00058\u0006@\u0006X\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u0006\u001a\u0004\u0018\u00010\u00078\u0006X\u0004¢\u0006\u0002\n\u0000¨\u0006\r"}, mo15462d2 = {"Lkotlinx/coroutines/flow/SharedFlowImpl$Emitter;", "Lkotlinx/coroutines/DisposableHandle;", "flow", "Lkotlinx/coroutines/flow/SharedFlowImpl;", "index", "", "value", "", "cont", "Lkotlin/coroutines/Continuation;", "", "(Lkotlinx/coroutines/flow/SharedFlowImpl;JLjava/lang/Object;Lkotlin/coroutines/Continuation;)V", "dispose", "kotlinx-coroutines-core"}, mo15463k = 1, mo15464mv = {1, 4, 0})
    /* compiled from: SharedFlow.kt */
    ...
    public final /* synthetic */ Object emitSuspend(T t, Continuation<? super Unit> continuation) {
        ...
        for (Continuation<Unit> continuation2 : continuationArr) {
            if (continuation2 != null) {
                ...
                continuation2.resumeWith(Result.m108constructorimpl(unit2));
            }
        }
