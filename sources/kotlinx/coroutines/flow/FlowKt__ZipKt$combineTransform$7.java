...
@DebugMetadata(mo16174c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7", mo16175f = "Zip.kt", mo16176i = {0}, mo16177l = {308}, mo16178m = "invokeSuspend", mo16179n = {"$this$flow"}, mo16180s = {"L$0"})
...
public final class FlowKt__ZipKt$combineTransform$7 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        flowKt__ZipKt$combineTransform$7.f261p$ = (FlowCollector) obj;
    ...
    @DebugMetadata(mo16174c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2", mo16175f = "Zip.kt", mo16176i = {0, 0}, mo16177l = {308}, mo16178m = "invokeSuspend", mo16179n = {"$this$combineInternal", "it"}, mo16180s = {"L$0", "L$1"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2 */
    /* compiled from: Zip.kt */
    public static final class C12282 extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
        Object L$0;
        Object L$1;
        int label;
        ...
        public final Continuation<Unit> create(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
            C12282 r0 = new C12282(this.this$0, continuation);
            r0.f262p$ = flowCollector;
            r0.p$0 = tArr;
            return r0;
        }

        public final Object invoke(Object obj, Object obj2, Object obj3) {
            return ((C12282) create((FlowCollector) obj, (Object[]) obj2, (Continuation) obj3)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                FlowCollector flowCollector = this.f262p$;
        ...
        public final Object invokeSuspend$$forInline(Object obj) {
            this.this$0.$transform.invoke(this.f262p$, this.p$0, this);
            return Unit.INSTANCE;
        }
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            }, new C12282(this, (Continuation) null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else if (i == 1) {
            FlowCollector flowCollector2 = (FlowCollector) this.L$0;
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        ...
        }, new C12282(this, (Continuation) null), this);
        InlineMarker.mark(2);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
