...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m1519debounce8GFy2Ro(Flow<? extends T> flow, double d) {
        return FlowKt.debounce(flow, DelayKt.m1496toDelayMillisLRDsOJo(d));
    }
    ...
    public static final <T> Flow<T> m1520sample8GFy2Ro(Flow<? extends T> flow, double d) {
        return FlowKt.sample(flow, DelayKt.m1496toDelayMillisLRDsOJo(d));
    }
}
