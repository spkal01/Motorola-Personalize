...
@DebugMetadata(mo16174c = "kotlinx.coroutines.flow.FlowKt__MergeKt$mapLatest$1", mo16175f = "Merge.kt", mo16176i = {0, 0, 1, 1}, mo16177l = {214, 214}, mo16178m = "invokeSuspend", mo16179n = {"$this$transformLatest", "it", "$this$transformLatest", "it"}, mo16180s = {"L$0", "L$1", "L$0", "L$1"})
...
final class FlowKt__MergeKt$mapLatest$1 extends SuspendLambda implements Function3<FlowCollector<? super R>, T, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(FlowCollector<? super R> flowCollector, T t, Continuation<? super Unit> continuation) {
        ...
        flowKt__MergeKt$mapLatest$1.f233p$ = flowCollector;
