...
@DebugMetadata(mo16174c = "kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1", mo16175f = "Delay.kt", mo16176i = {0, 0}, mo16177l = {352}, mo16178m = "invokeSuspend", mo16179n = {"$this$produce", "$this$collect$iv"}, mo16180s = {"L$0", "L$1"})
...
final class FlowKt__DelayKt$sample$2$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        flowKt__DelayKt$sample$2$values$1.f226p$ = (ProducerScope) obj;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            ProducerScope producerScope = this.f226p$;
            Flow flow = this.this$0.$this_sample;
            this.L$0 = producerScope;
            this.L$1 = flow;
            this.label = 1;
            if (flow.collect(new C1122xe7e632(producerScope), this) == coroutine_suspended) {
