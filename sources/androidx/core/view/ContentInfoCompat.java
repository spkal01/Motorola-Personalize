...
public final class ContentInfoCompat {
    ...
    public String toString() {
        String str = "";
        StringBuilder append = new StringBuilder().append("ContentInfoCompat{clip=").append(this.mClip.getDescription()).append(", source=").append(sourceToString(this.mSource)).append(", flags=").append(flagsToString(this.mFlags)).append(this.mLinkUri == null ? str : ", hasLinkUri(" + this.mLinkUri.toString().length() + ")");
