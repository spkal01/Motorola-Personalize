...
class FontProvider {
    private static final Comparator<byte[]> sByteArrayComparator = new Comparator<byte[]>() {
        ...
        public int compare(byte[] r4, byte[] r5) {
            ...
            L_0x001b:
                return r3
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.core.provider.FontProvider.C02131.compare(byte[], byte[]):int");
        }
    };
    ...
    static FontsContractCompat.FontInfo[] query(Context context, FontRequest fontRequest, String str, CancellationSignal cancellationSignal) {
        ...
        Uri build2 = new Uri.Builder().scheme("content").authority(str2).appendPath(OnlineFontServiceImpl.Fonts.FONT_ATTR_FILE).build();
        Cursor cursor = null;
        try {
