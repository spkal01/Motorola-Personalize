...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    ModernAsyncTask() {
        C04662 r0 = new WorkerRunnable<Params, Result>() {
    ...
    static /* synthetic */ class C04684 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.loader.content.ModernAsyncTask.C04684.<clinit>():void");
        }
    }

    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor executor, Params... paramsArr) {
        if (this.mStatus != Status.PENDING) {
            int i = C04684.$SwitchMap$androidx$loader$content$ModernAsyncTask$Status[this.mStatus.ordinal()];
            if (i == 1) {
