...
public abstract class FragmentStateAdapter extends RecyclerView.Adapter<FragmentViewHolder> implements StatefulAdapter {
        ...
        if (fragment != null) {
            ...
            if (!fragment.isAdded() && view != null) {
                ...
                if (fragment.isAdded()) {
                    ...
                    scheduleViewAttach(fragment, container);
                    this.mFragmentManager.beginTransaction().add(fragment, PersonalizeMetrics.TOPIC_FONT + fragmentViewHolder.getItemId()).setMaxLifecycle(fragment, Lifecycle.State.STARTED).commitNow();
    ...
    class FragmentMaxLifecycleEnforcer {
        ...
        public void register(RecyclerView recyclerView) {
            ...
            C06401 r2 = new ViewPager2.OnPageChangeCallback() {
            ...
            C06412 r22 = new DataSetChangeObserver() {
