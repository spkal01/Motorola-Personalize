...
@Metadata(mo15460bv = {1, 0, 3}, mo15461d1 = {"\u0000\u001d\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0018\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007H\u0016¨\u0006\b¸\u0006\u0000"}, mo15462d2 = {"androidx/lifecycle/WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$2$observer$1", "Landroidx/lifecycle/LifecycleEventObserver;", "onStateChanged", "", "source", "Landroidx/lifecycle/LifecycleOwner;", "event", "Landroidx/lifecycle/Lifecycle$Event;", "lifecycle-runtime-ktx_release"}, mo15463k = 1, mo15464mv = {1, 4, 1})
...
public final class C0437x3029b39e implements LifecycleEventObserver {
    ...
    C0437x3029b39e(CancellableContinuation cancellableContinuation, Lifecycle lifecycle, Lifecycle.State state, Function0 function0, boolean z, CoroutineDispatcher coroutineDispatcher) {
    ...
    public void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
        ...
        if (event == Lifecycle.Event.upTo(this.$state$inlined)) {
            ...
            try {
                ...
                obj = Result.m108constructorimpl(function0.invoke());
            } catch (Throwable th) {
            ...
            this.$co.resumeWith(Result.m108constructorimpl(ResultKt.createFailure(new LifecycleDestroyedException())));
        }
    }
}
