...
import androidx.databinding.library.C0295R;
...
public abstract class ViewDataBinding extends BaseObservable implements ViewBinding {
    ...
    public void setRootTag(View view) {
        view.setTag(C0295R.C0298id.dataBinding, this);
    }

    /* access modifiers changed from: protected */
    public void setRootTag(View[] viewArr) {
        for (View tag : viewArr) {
            tag.setTag(C0295R.C0298id.dataBinding, this);
        }
    }
    ...
    static ViewDataBinding getBinding(View view) {
        if (view != null) {
            return (ViewDataBinding) view.getTag(C0295R.C0298id.dataBinding);
        }
        return null;
    }
