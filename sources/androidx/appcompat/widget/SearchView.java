...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        C01115 r1 = new View.OnClickListener() {
        ...
        C01137 r2 = new TextView.OnEditorActionListener() {
        ...
        C01148 r3 = new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                SearchView.this.onItemClicked(i, 0, (String) null);
            }
        };
        this.mOnItemClickListener = r3;
        C01159 r4 = new AdapterView.OnItemSelectedListener() {
        ...
        LayoutInflater.from(context).inflate(obtainStyledAttributes.getResourceId(C0028R.styleable.SearchView_layout, C0028R.layout.abc_search_view), this, true);
