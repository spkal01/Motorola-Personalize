...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
        ...
        if (z2 && !sInstalledExceptionHandler) {
            ...
            Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
                ...
                private boolean shouldWrapException(Throwable th) {
                    ...
                    if (message.contains(IconPack.DRAWABLE) || message.contains("Drawable")) {
                        return true;
                    }
                    return false;
                }
    ...
    private ViewGroup createSubDecor() {
        ...
        if (obtainStyledAttributes.hasValue(C0028R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                ...
                viewGroup = (ViewGroup) LayoutInflater.from(context).inflate(C0028R.layout.abc_screen_toolbar, (ViewGroup) null);
    ...
    public androidx.appcompat.view.ActionMode startSupportActionModeFromWindow(androidx.appcompat.view.ActionMode.Callback r8) {
        ...
        L_0x0029:
            ...
            int r5 = androidx.appcompat.C0028R.attr.actionBarTheme
        ...
        L_0x006a:
            ...
            int r6 = androidx.appcompat.C0028R.attr.actionModePopupWindowStyle
            r5.<init>(r4, r1, r6)
            ...
            int r6 = androidx.appcompat.C0028R.attr.actionBarSize
        ...
        L_0x00b5:
            ...
            int r4 = androidx.appcompat.C0028R.C0031id.action_mode_bar_stub
    ...
    public android.view.View createView(android.view.View r12, java.lang.String r13, android.content.Context r14, android.util.AttributeSet r15) {
        /*
            ...
            int[] r2 = androidx.appcompat.C0028R.styleable.AppCompatTheme
            android.content.res.TypedArray r0 = r0.obtainStyledAttributes(r2)
            int r2 = androidx.appcompat.C0028R.styleable.AppCompatTheme_viewInflaterClass
    ...
    private boolean initializePanelMenu(PanelFeatureState panelFeatureState) {
        ...
        if ((panelFeatureState.featureId == 0 || panelFeatureState.featureId == 108) && this.mDecorContentParent != null) {
            ...
            theme.resolveAttribute(C0028R.attr.actionBarTheme, typedValue, true);
    ...
    private void updateStatusGuardColor(View view) {
        ...
        if ((ViewCompat.getWindowSystemUiVisibility(view) & 8192) != 0) {
            i = ContextCompat.getColor(this.mContext, C0028R.C0029color.abc_decor_view_status_guard_light);
        } else {
            i = ContextCompat.getColor(this.mContext, C0028R.C0029color.abc_decor_view_status_guard);
        }
    ...
    protected static final class PanelFeatureState {
        ...
        public MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                ListMenuPresenter listMenuPresenter2 = new ListMenuPresenter(this.listPresenterContext, C0028R.layout.abc_list_menu_item_layout);
