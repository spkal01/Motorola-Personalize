...
class AlertController {
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes((AttributeSet) null, C0028R.styleable.AlertDialog, C0028R.attr.alertDialogStyle, 0);
    ...
    private void setupView() {
        ...
        if (z2) {
            ...
            if (!(this.mMessage == null && this.mListView == null)) {
                view = resolvePanel.findViewById(C0028R.C0031id.titleDividerNoCustom);
            }
            if (view != null) {
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        final View findViewById = this.mWindow.findViewById(C0028R.C0031id.scrollIndicatorUp);
        final View findViewById2 = this.mWindow.findViewById(C0028R.C0031id.scrollIndicatorDown);
