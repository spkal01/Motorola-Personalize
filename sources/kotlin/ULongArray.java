...
public final class ULongArray implements Collection<ULong>, KMappedMarker {
    ...
    public static boolean m337equalsimpl(long[] jArr, Object obj) {
        return (obj instanceof ULongArray) && Intrinsics.areEqual((Object) jArr, (Object) ((ULongArray) obj).m348unboximpl());
    }
    ...
    public boolean m347containsVKZWuLQ(long j) {
        return m335containsVKZWuLQ(this.storage, j);
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof ULong) {
            return m347containsVKZWuLQ(((ULong) obj).m331unboximpl());
        }
        return false;
    }
    ...
    public static final long m339getsVKNKU(long[] jArr, int i) {
        return ULong.m280constructorimpl(jArr[i]);
    }
    ...
    public static java.util.Iterator<ULong> m343iteratorimpl(long[] jArr) {
        return new Iterator(jArr);
    }

    @Metadata(mo15461d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0016\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0002\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\t\u0010\u0007\u001a\u00020\bH\u0002J\u0015\u0010\t\u001a\u00020\nH\u0016ø\u0001\u0000ø\u0001\u0001¢\u0006\u0004\b\u000b\u0010\fR\u000e\u0010\u0002\u001a\u00020\u0003X\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u000e¢\u0006\u0002\n\u0000\u0002\b\n\u0002\b\u0019\n\u0002\b!¨\u0006\r"}, mo15462d2 = {"Lkotlin/ULongArray$Iterator;", "Lkotlin/collections/ULongIterator;", "array", "", "([J)V", "index", "", "hasNext", "", "nextULong", "Lkotlin/ULong;", "nextULong-s-VKNKU", "()J", "kotlin-stdlib"}, mo15463k = 1, mo15464mv = {1, 5, 1})
    /* compiled from: ULongArray.kt */
    private static final class Iterator extends ULongIterator {
        ...
        public long m349nextULongsVKNKU() {
            int i = this.index;
    ...
    public static boolean m336containsAllimpl(long[] jArr, Collection<ULong> collection) {
        boolean z;
        Intrinsics.checkNotNullParameter(collection, "elements");
        Iterable iterable = collection;
        if (!((Collection) iterable).isEmpty()) {
            for (Object next : iterable) {
                if (!(next instanceof ULong) || !ArraysKt.contains(jArr, ((ULong) next).m331unboximpl())) {
                    z = false;
                    continue;
                } else {
                    z = true;
