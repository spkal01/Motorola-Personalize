...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m1299getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object obj) {
        synchronized (this) {
            this.result = Result.m107boximpl(obj);
            notifyAll();
        ...
        synchronized (this) {
            while (true) {
                ...
                if (result2 == null) {
                    ...
                    ResultKt.throwOnFailure(result2.m117unboximpl());
                }
            }
        }
    }
