...
class StringsKt__StringsJVMKt extends StringsKt__StringNumberConversionsKt {
    ...
    public static final boolean startsWith(String str, String str2, boolean z) {
        ...
        Intrinsics.checkNotNullParameter(str2, IconPack.PREFIX);
        if (!z) {
