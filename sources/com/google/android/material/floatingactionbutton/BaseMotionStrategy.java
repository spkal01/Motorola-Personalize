...
abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    public AnimatorSet createAnimator(MotionSpec motionSpec2) {
        ...
        if (motionSpec2.hasPropertyValues(IconPack.SCALE)) {
            arrayList.add(motionSpec2.getAnimator(IconPack.SCALE, this.fab, View.SCALE_Y));
            arrayList.add(motionSpec2.getAnimator(IconPack.SCALE, this.fab, View.SCALE_X));
        }
