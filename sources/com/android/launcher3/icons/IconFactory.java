...
public class IconFactory extends BaseIconFactory {
    ...
    public static IconFactory obtain(Context context) {
        synchronized (sPoolSync) {
            ...
            int i = sPoolId;
            return new IconFactory(context, context.getResources().getConfiguration().densityDpi, context.getResources().getDimensionPixelSize(C0738R.dimen.default_icon_bitmap_size), i);
        }
    }
