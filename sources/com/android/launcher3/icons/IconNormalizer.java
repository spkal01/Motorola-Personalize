...
public class IconNormalizer {
    ...
    public synchronized float getScale(android.graphics.drawable.Drawable r17, android.graphics.RectF r18, android.graphics.Path r19, boolean[] r20) {
        /*
            ...
            r3 = r20
            monitor-enter(r16)
            boolean r4 = com.android.launcher3.icons.BaseIconFactory.ATLEAST_OREO     // Catch:{ all -> 0x0146 }
            r5 = 0
            if (r4 == 0) goto L_0x002d
            boolean r4 = r0 instanceof android.graphics.drawable.AdaptiveIconDrawable     // Catch:{ all -> 0x0146 }
            if (r4 == 0) goto L_0x002d
            float r3 = r1.mAdaptiveIconScale     // Catch:{ all -> 0x0146 }
            int r3 = (r3 > r5 ? 1 : (r3 == r5 ? 0 : -1))
            if (r3 != 0) goto L_0x0022
            int r3 = r1.mMaxSize     // Catch:{ all -> 0x0146 }
            android.graphics.RectF r4 = r1.mAdaptiveIconBounds     // Catch:{ all -> 0x0146 }
            float r0 = normalizeAdaptiveIcon(r0, r3, r4)     // Catch:{ all -> 0x0146 }
            r1.mAdaptiveIconScale = r0     // Catch:{ all -> 0x0146 }
        L_0x0022:
            if (r2 == 0) goto L_0x0029
            android.graphics.RectF r0 = r1.mAdaptiveIconBounds     // Catch:{ all -> 0x0146 }
            r2.set(r0)     // Catch:{ all -> 0x0146 }
        L_0x0029:
            float r0 = r1.mAdaptiveIconScale     // Catch:{ all -> 0x0146 }
            monitor-exit(r16)
            return r0
        L_0x002d:
            int r4 = r17.getIntrinsicWidth()     // Catch:{ all -> 0x0146 }
            int r6 = r17.getIntrinsicHeight()     // Catch:{ all -> 0x0146 }
            if (r4 <= 0) goto L_0x004c
            if (r6 > 0) goto L_0x003a
            goto L_0x004c
        L_0x003a:
            int r7 = r1.mMaxSize     // Catch:{ all -> 0x0146 }
            if (r4 > r7) goto L_0x0040
            if (r6 <= r7) goto L_0x005c
        L_0x0040:
            int r7 = java.lang.Math.max(r4, r6)     // Catch:{ all -> 0x0146 }
            int r8 = r1.mMaxSize     // Catch:{ all -> 0x0146 }
            int r4 = r4 * r8
            int r4 = r4 / r7
            int r8 = r8 * r6
            int r6 = r8 / r7
        ...
        L_0x0052:
            int r4 = r1.mMaxSize     // Catch:{ all -> 0x0146 }
        L_0x0054:
            if (r6 <= 0) goto L_0x005a
            int r7 = r1.mMaxSize     // Catch:{ all -> 0x0146 }
            if (r6 <= r7) goto L_0x005c
        L_0x005a:
            int r6 = r1.mMaxSize     // Catch:{ all -> 0x0146 }
        L_0x005c:
            android.graphics.Bitmap r7 = r1.mBitmap     // Catch:{ all -> 0x0146 }
            r8 = 0
            r7.eraseColor(r8)     // Catch:{ all -> 0x0146 }
            r0.setBounds(r8, r8, r4, r6)     // Catch:{ all -> 0x0146 }
            android.graphics.Canvas r7 = r1.mCanvas     // Catch:{ all -> 0x0146 }
            r0.draw(r7)     // Catch:{ all -> 0x0146 }
            byte[] r0 = r1.mPixels     // Catch:{ all -> 0x0146 }
            java.nio.ByteBuffer r0 = java.nio.ByteBuffer.wrap(r0)     // Catch:{ all -> 0x0146 }
            r0.rewind()     // Catch:{ all -> 0x0146 }
            android.graphics.Bitmap r7 = r1.mBitmap     // Catch:{ all -> 0x0146 }
            r7.copyPixelsToBuffer(r0)     // Catch:{ all -> 0x0146 }
            int r0 = r1.mMaxSize     // Catch:{ all -> 0x0146 }
            int r7 = r0 + 1
            int r0 = r0 - r4
            r10 = r8
            r14 = r10
        ...
        L_0x0087:
            ...
            byte[] r9 = r1.mPixels     // Catch:{ all -> 0x0146 }
            byte r9 = r9[r14]     // Catch:{ all -> 0x0146 }
        ...
        L_0x009f:
            int r14 = r14 + r0
            float[] r3 = r1.mLeftBorder     // Catch:{ all -> 0x0146 }
            float r9 = (float) r5     // Catch:{ all -> 0x0146 }
            r3[r10] = r9     // Catch:{ all -> 0x0146 }
            float[] r3 = r1.mRightBorder     // Catch:{ all -> 0x0146 }
            float r9 = (float) r8     // Catch:{ all -> 0x0146 }
            r3[r10] = r9     // Catch:{ all -> 0x0146 }
            r3 = -1
            ...
            r11 = r10
        L_0x00b0:
            int r3 = java.lang.Math.min(r7, r5)     // Catch:{ all -> 0x0146 }
            int r12 = java.lang.Math.max(r12, r8)     // Catch:{ all -> 0x0146 }
            r7 = r3
            r13 = r10
        L_0x00ba:
            int r10 = r10 + 1
        ...
        L_0x00c1:
            ...
            goto L_0x0144
        L_0x00ca:
            float[] r5 = r1.mLeftBorder     // Catch:{ all -> 0x0146 }
            r8 = 1
            convertToConvexArray(r5, r8, r11, r13)     // Catch:{ all -> 0x0146 }
            float[] r5 = r1.mRightBorder     // Catch:{ all -> 0x0146 }
            convertToConvexArray(r5, r3, r11, r13)     // Catch:{ all -> 0x0146 }
            r3 = 0
            r5 = 0
        L_0x00d7:
            if (r3 >= r6) goto L_0x00f0
            float[] r9 = r1.mLeftBorder     // Catch:{ all -> 0x0146 }
            r10 = r9[r3]     // Catch:{ all -> 0x0146 }
            r14 = -1082130432(0xffffffffbf800000, float:-1.0)
            int r10 = (r10 > r14 ? 1 : (r10 == r14 ? 0 : -1))
            if (r10 > 0) goto L_0x00e4
            goto L_0x00ed
        L_0x00e4:
            float[] r10 = r1.mRightBorder     // Catch:{ all -> 0x0146 }
            r10 = r10[r3]     // Catch:{ all -> 0x0146 }
            r9 = r9[r3]     // Catch:{ all -> 0x0146 }
            float r10 = r10 - r9
            float r10 = r10 + r0
            float r5 = r5 + r10
        L_0x00ed:
            ...
            goto L_0x00d7
        L_0x00f0:
            android.graphics.Rect r3 = r1.mBounds     // Catch:{ all -> 0x0146 }
            r3.left = r7     // Catch:{ all -> 0x0146 }
            android.graphics.Rect r3 = r1.mBounds     // Catch:{ all -> 0x0146 }
            r3.right = r12     // Catch:{ all -> 0x0146 }
            android.graphics.Rect r3 = r1.mBounds     // Catch:{ all -> 0x0146 }
            r3.top = r11     // Catch:{ all -> 0x0146 }
            android.graphics.Rect r3 = r1.mBounds     // Catch:{ all -> 0x0146 }
            r3.bottom = r13     // Catch:{ all -> 0x0146 }
            if (r2 == 0) goto L_0x0122
            android.graphics.Rect r3 = r1.mBounds     // Catch:{ all -> 0x0146 }
            int r3 = r3.left     // Catch:{ all -> 0x0146 }
            float r3 = (float) r3     // Catch:{ all -> 0x0146 }
            float r9 = (float) r4     // Catch:{ all -> 0x0146 }
            float r3 = r3 / r9
            android.graphics.Rect r10 = r1.mBounds     // Catch:{ all -> 0x0146 }
            int r10 = r10.top     // Catch:{ all -> 0x0146 }
            float r10 = (float) r10     // Catch:{ all -> 0x0146 }
            float r14 = (float) r6     // Catch:{ all -> 0x0146 }
            float r10 = r10 / r14
            android.graphics.Rect r15 = r1.mBounds     // Catch:{ all -> 0x0146 }
            int r15 = r15.right     // Catch:{ all -> 0x0146 }
            float r15 = (float) r15     // Catch:{ all -> 0x0146 }
            float r15 = r15 / r9
            float r9 = r0 - r15
            android.graphics.Rect r15 = r1.mBounds     // Catch:{ all -> 0x0146 }
            int r15 = r15.bottom     // Catch:{ all -> 0x0146 }
            float r15 = (float) r15     // Catch:{ all -> 0x0146 }
            float r15 = r15 / r14
            float r0 = r0 - r15
            r2.set(r3, r10, r9, r0)     // Catch:{ all -> 0x0146 }
        L_0x0122:
            r0 = r20
            if (r0 == 0) goto L_0x0136
            boolean r2 = r1.mEnableShapeDetection     // Catch:{ all -> 0x0146 }
            if (r2 == 0) goto L_0x0136
            int r2 = r0.length     // Catch:{ all -> 0x0146 }
            if (r2 <= 0) goto L_0x0136
            r2 = r19
            boolean r2 = r1.isShape(r2)     // Catch:{ all -> 0x0146 }
            r3 = 0
            r0[r3] = r2     // Catch:{ all -> 0x0146 }
        L_0x0136:
            int r13 = r13 + r8
            int r13 = r13 - r11
            int r12 = r12 + r8
            ...
            int r4 = r4 * r6
            float r2 = (float) r4     // Catch:{ all -> 0x0146 }
            float r0 = getScale(r5, r0, r2)     // Catch:{ all -> 0x0146 }
            monitor-exit(r16)
            return r0
        L_0x0144:
            monitor-exit(r16)
