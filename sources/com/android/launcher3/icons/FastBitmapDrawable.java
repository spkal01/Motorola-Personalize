...
public class FastBitmapDrawable extends Drawable {
    ...
    private static final Property<FastBitmapDrawable, Float> SCALE = new Property<FastBitmapDrawable, Float>(Float.TYPE, IconPack.SCALE) {
    ...
    public final void draw(Canvas canvas) {
        ...
        if (this.mChecked && this.mCheckedIcon != null && this.mCheckedShapePath != null && this.mCheckedColor != 0) {
            if (!(this instanceof ClockDrawableWrapper.ClockIconDrawable)) {
                canvas.scale(ExtendedBitmapInfo.sScale, ExtendedBitmapInfo.sScale, rect.exactCenterX() + ((float) ExtendedBitmapInfo.sOffset), rect.exactCenterY() + ((float) ExtendedBitmapInfo.sOffset));
            }
    ...
    public boolean isShowPressAnim() {
        return this.mShowPressAnim;
    }

    public void setShowPressAnim(boolean z) {
        this.mShowPressAnim = z;
    }
    ...
    public void setCheckedShapePath(Path path) {
        this.mCheckedShapePath = path;
    }
